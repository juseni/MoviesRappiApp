...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.juan.nino.moviesrappiapp.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.juan.nino.moviesrappiapp.utils.GlideOptions().apply(toSet));
    }
  }
}
